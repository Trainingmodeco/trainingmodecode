...
export default function MissionIntegrityBanner({ integrityResult, onRetry, onHome }) {
  ...
  // numbers actually explain a withheld/blocked result. (1.6 motion is a
  // positive-only bonus surfaced as STRIKES ✓ on the summary — it never adds a
  // negative note here, because a stationary phone is a normal, valid setup.)
