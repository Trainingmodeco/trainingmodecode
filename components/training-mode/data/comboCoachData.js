const COMBO_POOL = [
  ...
  { id: 'kb-14', discipline: 'kickboxing', minDifficulty: 'normal', comboText: 'Double Jab Body Kick', category: 'combination', coachingCue: 'Jab high twice, then kick the liver.' },
  ...
  // ---- BOXING: deeper hard/advanced material (anti-repeat content lift) ----
  { id: 'bc-39', discipline: 'boxing', minDifficulty: 'normal', comboText: 'Jab Uppercut Cross', category: 'combination', coachingCue: 'Split the guard, then straight through.' },
  { id: 'bc-40', discipline: 'boxing', minDifficulty: 'normal', comboText: 'Cross Uppercut Hook', category: 'combination', coachingCue: 'Rear upper lifts the chin, hook collects it.' },
  { id: 'bc-41', discipline: 'boxing', minDifficulty: 'normal', comboText: 'Double Jab Body Cross', category: 'combination', coachingCue: 'Two up top buys the low cross.' },
  { id: 'bc-42', discipline: 'boxing', minDifficulty: 'normal', comboText: 'Hook Cross Hook', category: 'combination', coachingCue: 'Outside, inside, outside.' },
  { id: 'bc-43', discipline: 'boxing', minDifficulty: 'normal', comboText: 'Jab Body Cross Hook', category: 'combination', coachingCue: 'Down, then back upstairs.' },
  { id: 'bc-44', discipline: 'boxing', minDifficulty: 'normal', comboText: 'Jab Cross Roll Cross', category: 'counter', coachingCue: 'Throw, roll under the return, answer.' },
  { id: 'bc-45', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Jab Cross Hook Body Cross Hook', category: 'advanced', coachingCue: 'Six punches, two levels. Stay balanced.' },
  { id: 'bc-46', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Double Jab Overhand Hook', category: 'advanced', coachingCue: 'Two jabs set the arc of the overhand.' },
  { id: 'bc-47', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Cross Hook Cross Body Hook', category: 'advanced', coachingCue: 'Finish the four-piece downstairs.' },
  { id: 'bc-48', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Jab Cross Uppercut Hook Cross', category: 'advanced', coachingCue: 'Straight, up the middle, around, straight.' },
  { id: 'bc-49', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Body Jab Cross Hook Cross', category: 'advanced', coachingCue: 'Start low so the hands drop.' },
  { id: 'bc-50', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Jab Body Cross Uppercut Hook', category: 'advanced', coachingCue: 'Level change, then two on the inside.' },
  { id: 'bc-51', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Lead Uppercut Cross Hook Body Cross', category: 'advanced', coachingCue: 'The lead uppercut opens the centre.' },
  { id: 'bc-52', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Jab Cross Body Hook Overhand', category: 'advanced', coachingCue: 'Dig the body, come over the top.' },
  { id: 'bc-53', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Slip Jab Cross Body Hook', category: 'counter', coachingCue: 'Slip first, punish second.' },
  { id: 'bc-54', discipline: 'boxing', minDifficulty: 'hard', comboText: 'Parry Jab Cross Uppercut', category: 'counter', coachingCue: 'Deflect, then take the centre.' },
  { id: 'bc-55', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Jab Cross Hook Cross Body Hook Uppercut', category: 'elite', coachingCue: 'Six-piece. Breathe on every punch.' },
  { id: 'bc-56', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Double Jab Cross Hook Body Cross Hook', category: 'elite', coachingCue: 'Volume with a level change buried in it.' },
  { id: 'bc-57', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Jab Body Cross Hook Uppercut Cross Hook', category: 'elite', coachingCue: 'Seven punches. Feet keep up with the hands.' },
  { id: 'bc-58', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Cross Hook Uppercut Body Cross Hook Cross', category: 'elite', coachingCue: 'Start on the rear hand and end on it.' },
  { id: 'bc-59', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Jab Cross Overhand Hook Body Cross Uppercut', category: 'elite', coachingCue: 'Every angle in one sequence.' },
  { id: 'bc-60', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Body Jab Body Cross Hook Cross Overhand', category: 'elite', coachingCue: 'Two to the body buys the overhand.' },
  { id: 'bc-61', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Jab Uppercut Hook Cross Body Hook Cross', category: 'elite', coachingCue: 'Inside work, then straight back out.' },
  { id: 'bc-62', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Lead Uppercut Rear Uppercut Hook Cross Body Hook', category: 'elite', coachingCue: 'Both uppercuts, then the exit.' },
  { id: 'bc-63', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Jab Cross Hook Rear Overhand Body Cross Hook', category: 'elite', coachingCue: 'The overhand is the hinge. Chin stays tucked.' },
  { id: 'bc-64', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Double Jab Body Hook Cross Hook Cross', category: 'elite', coachingCue: 'Six punches, no wasted motion.' },
  { id: 'bc-65', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Feint Cross Hook Body Hook Cross Uppercut', category: 'elite', coachingCue: 'Sell the feint before you commit.' },
  { id: 'bc-66', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Jab Slip Cross Roll Hook Cross', category: 'counter', coachingCue: 'Defence between every punch.' },
  { id: 'bc-67', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Pull Counter Cross Hook Body Cross Hook', category: 'counter', coachingCue: 'Make them miss, then make them pay.' },
  { id: 'bc-68', discipline: 'boxing', minDifficulty: 'advanced', comboText: 'Check Hook Cross Body Hook Uppercut', category: 'counter', coachingCue: 'Pivot off the check hook, then work.' },

  // ---- KICKBOXING: deeper hard/advanced material (anti-repeat content lift) ----
  { id: 'kb-39', discipline: 'kickboxing', minDifficulty: 'normal', comboText: 'Jab Cross Low Kick Cross', category: 'combination', coachingCue: 'Kick lands, hands come straight back.' },
  { id: 'kb-40', discipline: 'kickboxing', minDifficulty: 'normal', comboText: 'Teep Jab Cross', category: 'combination', coachingCue: 'Push the range, then close it.' },
  { id: 'kb-41', discipline: 'kickboxing', minDifficulty: 'normal', comboText: 'Jab Body Kick Cross', category: 'combination', coachingCue: 'Kick off the jab, recover to stance.' },
  { id: 'kb-42', discipline: 'kickboxing', minDifficulty: 'normal', comboText: 'Cross Hook Low Kick', category: 'combination', coachingCue: 'Hands high, kick low.' },
  { id: 'kb-43', discipline: 'kickboxing', minDifficulty: 'normal', comboText: 'Switch Kick Jab Cross', category: 'combination', coachingCue: 'Land the switch, then chase with hands.' },
  { id: 'kb-44', discipline: 'kickboxing', minDifficulty: 'normal', comboText: 'Jab Cross Hook Body Kick', category: 'combination', coachingCue: 'Three punches disguise the kick.' },
  { id: 'kb-45', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Jab Cross Low Kick High Kick', category: 'advanced', coachingCue: 'Low first, high second, same leg.' },
  { id: 'kb-46', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Teep Cross Hook Low Kick Cross', category: 'advanced', coachingCue: 'Range, hands, leg, hands.' },
  { id: 'kb-47', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Switch Kick Cross Hook Body Kick', category: 'advanced', coachingCue: 'Both sides in one chain.' },
  { id: 'kb-48', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Jab Hook Cross Rear Kick', category: 'advanced', coachingCue: 'Turn the hip over on the last one.' },
  { id: 'kb-49', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Low Kick Low Kick Cross Hook', category: 'advanced', coachingCue: 'Two on the leg, then upstairs.' },
  { id: 'kb-50', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Jab Cross Body Kick High Kick', category: 'advanced', coachingCue: 'Body then head. Make them choose.' },
  { id: 'kb-51', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Check Cross Hook Low Kick', category: 'counter', coachingCue: 'Check clean, answer immediately.' },
  { id: 'kb-52', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Jab Teep Cross Roundhouse', category: 'advanced', coachingCue: 'Teep to break rhythm, roundhouse to finish.' },
  { id: 'kb-53', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Body Kick Cross Hook Low Kick', category: 'advanced', coachingCue: 'Open the body, close the legs.' },
  { id: 'kb-54', discipline: 'kickboxing', minDifficulty: 'hard', comboText: 'Jab Cross Hook Cross Low Kick', category: 'advanced', coachingCue: 'Four punches, then take the leg.' },
  { id: 'kb-55', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Jab Cross Low Kick Cross Hook High Kick', category: 'elite', coachingCue: 'Six beats, three levels.' },
  { id: 'kb-56', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Switch Kick Cross Hook Spinning Back Kick', category: 'elite', coachingCue: 'Commit to the spin only when they retreat.' },
  { id: 'kb-57', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Teep Jab Cross Body Kick Cross Hook', category: 'elite', coachingCue: 'Manage the range, then empty the tank.' },
  { id: 'kb-58', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Low Kick Cross Hook Switch Kick Cross', category: 'elite', coachingCue: 'Switch your feet mid-combination.' },
  { id: 'kb-59', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Jab Cross Hook Body Kick Low Kick', category: 'elite', coachingCue: 'Finish low when they cover high.' },
  { id: 'kb-60', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Feint Low Kick Cross Hook High Kick', category: 'elite', coachingCue: 'Sell the leg, take the head.' },
  { id: 'kb-61', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Double Jab Cross Roundhouse Cross', category: 'elite', coachingCue: 'Volume, then power.' },
  { id: 'kb-62', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Check Counter Cross Hook Body Kick', category: 'counter', coachingCue: 'Check, counter, keep going.' },
  { id: 'kb-63', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Jab Body Kick Cross Hook Spinning Backfist', category: 'elite', coachingCue: 'Only spin when your base is set.' },
  { id: 'kb-64', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Teep Cross Low Kick Hook Roundhouse', category: 'elite', coachingCue: 'Five weapons, five different lines.' },
  { id: 'kb-65', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Jab Cross High Kick Low Kick Cross', category: 'elite', coachingCue: 'High to low, then hands.' },
  { id: 'kb-66', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Switch Kick Jab Cross Hook Body Kick Cross', category: 'elite', coachingCue: 'Long chain. Guard stays up between kicks.' },
  { id: 'kb-67', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Low Kick Jab Cross Question Mark Kick', category: 'elite', coachingCue: 'Sell it low, finish it high.' },
  { id: 'kb-68', discipline: 'kickboxing', minDifficulty: 'advanced', comboText: 'Jab Cross Hook Low Kick Teep', category: 'elite', coachingCue: 'Finish with the teep to reset the range.' },

  // ---- MUAY-THAI: deeper hard/advanced material (anti-repeat content lift) ----
  { id: 'mt-39', discipline: 'muay-thai', minDifficulty: 'normal', comboText: 'Jab Cross Knee Cross', category: 'combination', coachingCue: 'Knee in the pocket, then straight back out.' },
  { id: 'mt-40', discipline: 'muay-thai', minDifficulty: 'normal', comboText: 'Teep Jab Cross Roundhouse', category: 'combination', coachingCue: 'Push, punch, turn the hip.' },
  { id: 'mt-41', discipline: 'muay-thai', minDifficulty: 'normal', comboText: 'Cross Elbow Hook', category: 'combination', coachingCue: 'Elbow short, hook long.' },
  { id: 'mt-42', discipline: 'muay-thai', minDifficulty: 'normal', comboText: 'Jab Body Kick Elbow', category: 'combination', coachingCue: 'Kick lands, elbow follows on the return.' },
  { id: 'mt-43', discipline: 'muay-thai', minDifficulty: 'normal', comboText: 'Clinch Knee Push', category: 'combination', coachingCue: 'Break the posture, then break the grip.' },
  { id: 'mt-44', discipline: 'muay-thai', minDifficulty: 'normal', comboText: 'Jab Cross Low Kick Teep', category: 'combination', coachingCue: 'Take the leg, then take the space.' },
  { id: 'mt-45', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Jab Cross Knee Elbow Roundhouse', category: 'advanced', coachingCue: 'Every range in one chain.' },
  { id: 'mt-46', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Teep Cross Elbow Knee', category: 'advanced', coachingCue: 'Long to short in three beats.' },
  { id: 'mt-47', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Clinch Knee Elbow Push Cross', category: 'advanced', coachingCue: 'Score inside, then reset outside.' },
  { id: 'mt-48', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Jab Cross Body Kick Knee', category: 'advanced', coachingCue: 'The kick brings them forward, the knee meets them.' },
  { id: 'mt-49', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Check Cross Elbow Body Kick', category: 'counter', coachingCue: 'Check clean, punish immediately.' },
  { id: 'mt-50', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Switch Kick Cross Elbow Knee', category: 'advanced', coachingCue: 'Switch the stance, keep the pressure.' },
  { id: 'mt-51', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Jab Elbow Cross Roundhouse', category: 'advanced', coachingCue: 'An early elbow breaks their rhythm.' },
  { id: 'mt-52', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Low Kick Cross Hook Knee', category: 'advanced', coachingCue: 'Chop the leg, then close the distance.' },
  { id: 'mt-53', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Teep Roundhouse Cross Elbow', category: 'advanced', coachingCue: 'Reset, turn over, close.' },
  { id: 'mt-54', discipline: 'muay-thai', minDifficulty: 'hard', comboText: 'Jab Cross Knee Body Kick Cross', category: 'advanced', coachingCue: 'Five beats. Never square up.' },
  { id: 'mt-55', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Jab Cross Elbow Knee Body Kick Cross', category: 'elite', coachingCue: 'Six weapons, no wasted step.' },
  { id: 'mt-56', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Clinch Knee Knee Elbow Push Cross Roundhouse', category: 'elite', coachingCue: 'Own the clinch, then exit on the kick.' },
  { id: 'mt-57', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Teep Jab Cross Elbow Knee Roundhouse', category: 'elite', coachingCue: 'Long range collapses to short.' },
  { id: 'mt-58', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Feint Cross Low Kick Elbow Knee', category: 'elite', coachingCue: 'Sell it, then take the inside.' },
  { id: 'mt-59', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Switch Kick Cross Hook Elbow Knee', category: 'elite', coachingCue: 'Switch, strike, close, finish.' },
  { id: 'mt-60', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Jab Body Kick Elbow Clinch Knee Knee', category: 'elite', coachingCue: 'Kick to enter, clinch to score.' },
  { id: 'mt-61', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Check Counter Elbow Cross Body Kick', category: 'counter', coachingCue: 'Check, counter, turn it over.' },
  { id: 'mt-62', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Low Kick Cross Elbow Knee Teep', category: 'elite', coachingCue: 'Finish with the teep to break the grip.' },
  { id: 'mt-63', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Jab Cross Roundhouse Elbow Knee Cross', category: 'elite', coachingCue: 'Long chain. Breathe on the elbow.' },
  { id: 'mt-64', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Frame Elbow Knee Push Roundhouse', category: 'elite', coachingCue: 'Frame first or you get dragged down.' },
  { id: 'mt-65', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Catch Kick Sweep Cross Elbow', category: 'elite', coachingCue: 'Catch, sweep, finish standing.' },
  { id: 'mt-66', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Teep Cross Hook Spinning Elbow', category: 'elite', coachingCue: 'Only spin when they circle into it.' },
  { id: 'mt-67', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Clinch Knee Elbow Break Cross Low Kick', category: 'elite', coachingCue: 'Score, break, punish the exit.' },
  { id: 'mt-68', discipline: 'muay-thai', minDifficulty: 'advanced', comboText: 'Jab Cross Knee Elbow Clinch Knee Push', category: 'elite', coachingCue: 'Enter, score, and get out clean.' },

  // ---- MMA: deeper hard/advanced material (anti-repeat content lift) ----
  { id: 'mma-39', discipline: 'mma', minDifficulty: 'normal', comboText: 'Jab Cross Low Kick Sprawl', category: 'combination', coachingCue: 'Punish the leg, be ready for the shot.' },
  { id: 'mma-40', discipline: 'mma', minDifficulty: 'normal', comboText: 'Level Change Cross Hook', category: 'combination', coachingCue: 'Sell the takedown, throw the hands.' },
  { id: 'mma-41', discipline: 'mma', minDifficulty: 'normal', comboText: 'Jab Overhand Level Change', category: 'combination', coachingCue: 'The overhand hides the entry.' },
  { id: 'mma-42', discipline: 'mma', minDifficulty: 'normal', comboText: 'Cross Knee Clinch', category: 'combination', coachingCue: 'Land the knee, then tie up.' },
  { id: 'mma-43', discipline: 'mma', minDifficulty: 'normal', comboText: 'Jab Body Kick Exit', category: 'combination', coachingCue: 'Kick and get off the line.' },
  { id: 'mma-44', discipline: 'mma', minDifficulty: 'normal', comboText: 'Sprawl Cross Knee', category: 'counter', coachingCue: 'Stuff it, then make them pay.' },
  { id: 'mma-45', discipline: 'mma', minDifficulty: 'hard', comboText: 'Jab Cross Overhand Level Change Cross', category: 'advanced', coachingCue: 'Hands, then the fake entry.' },
  { id: 'mma-46', discipline: 'mma', minDifficulty: 'hard', comboText: 'Low Kick Cross Hook Clinch Knee', category: 'advanced', coachingCue: 'Kick to close, clinch to score.' },
  { id: 'mma-47', discipline: 'mma', minDifficulty: 'hard', comboText: 'Sprawl Cross Hook Body Kick', category: 'counter', coachingCue: 'Stuff, stand, kick.' },
  { id: 'mma-48', discipline: 'mma', minDifficulty: 'hard', comboText: 'Jab Level Change Overhand Knee', category: 'advanced', coachingCue: 'Threaten low, land high.' },
  { id: 'mma-49', discipline: 'mma', minDifficulty: 'hard', comboText: 'Cross Hook Clinch Knee Elbow', category: 'advanced', coachingCue: 'Inside work. Short weapons only.' },
  { id: 'mma-50', discipline: 'mma', minDifficulty: 'hard', comboText: 'Fake Shot Overhand Hook Exit', category: 'advanced', coachingCue: 'Sell the shot, then get out.' },
  { id: 'mma-51', discipline: 'mma', minDifficulty: 'hard', comboText: 'Jab Cross Body Kick Sprawl Cross', category: 'advanced', coachingCue: 'Expect the counter shot every time.' },
  { id: 'mma-52', discipline: 'mma', minDifficulty: 'hard', comboText: 'Switch Kick Cross Clinch Knee', category: 'advanced', coachingCue: 'Kick straight into the clinch.' },
  { id: 'mma-53', discipline: 'mma', minDifficulty: 'hard', comboText: 'Level Change Cross Hook Low Kick', category: 'advanced', coachingCue: 'Fake the entry, then work the outside.' },
  { id: 'mma-54', discipline: 'mma', minDifficulty: 'hard', comboText: 'Jab Overhand Elbow Clinch Knee', category: 'advanced', coachingCue: 'Overhand, elbow, tie up.' },
  { id: 'mma-55', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Jab Cross Overhand Fake Shot Flying Knee', category: 'elite', coachingCue: 'Only fly when they duck.' },
  { id: 'mma-56', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Low Kick Jab Cross Level Change Ground Pound', category: 'elite', coachingCue: 'Finish the entry, finish on top.' },
  { id: 'mma-57', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Sprawl Cross Hook Clinch Knee Elbow Exit', category: 'elite', coachingCue: 'Defend, score, leave clean.' },
  { id: 'mma-58', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Jab Body Kick Overhand Clinch Knee Throw', category: 'elite', coachingCue: 'Kick, punch, tie, trip.' },
  { id: 'mma-59', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Feint Level Change Overhand Hook Body Kick', category: 'elite', coachingCue: 'The fake entry buys every strike after it.' },
  { id: 'mma-60', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Clinch Knee Elbow Push Cross Low Kick', category: 'elite', coachingCue: 'Score inside, punish the exit.' },
  { id: 'mma-61', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Jab Cross Hook Sprawl Cross Overhand', category: 'elite', coachingCue: 'Chain your defence into offence.' },
  { id: 'mma-62', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Switch Kick Cross Overhand Level Change Knee', category: 'elite', coachingCue: 'Every level in one sequence.' },
  { id: 'mma-63', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Jab Cross Elbow Clinch Knee Knee Throw', category: 'elite', coachingCue: 'Two knees before the trip.' },
  { id: 'mma-64', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Oblique Kick Cross Hook Fake Shot Overhand', category: 'elite', coachingCue: 'Break the stance, then hit the head.' },
  { id: 'mma-65', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Sprawl Cross Clinch Knee Elbow Body Kick', category: 'elite', coachingCue: 'Never stop moving after the sprawl.' },
  { id: 'mma-66', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Jab Overhand Superman Punch Clinch Knee', category: 'elite', coachingCue: 'Commit to the superman or skip it.' },
  { id: 'mma-67', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Level Change Cross Hook Body Kick Sprawl Cross', category: 'elite', coachingCue: 'Long chain. Keep your base under you.' },
  { id: 'mma-68', discipline: 'mma', minDifficulty: 'advanced', comboText: 'Jab Cross Knee Elbow Level Change Ground Pound', category: 'elite', coachingCue: 'Strike standing, finish grounded.' },
];
