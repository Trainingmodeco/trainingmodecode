...
const POSTER_MAP = {
  ...
  'grappler-protocol': '/static/series/posters/grappler-protocol.png',
  'martial-monster-protocol': '/static/series/posters/hero-hunter.png',
  'struggler-protocol': '/static/series/posters/struggler-protocol.png',
    ...
    <PhoneFrame>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', padding: '14px 16px 8px', textAlign: 'center' }}>
          ...
          <button data-tour="challenge-code" data-guide="ar-code" onClick={() => setCodeOpen(true)} style={{ marginTop: 7, background: 'rgba(168,85,247,0.12)', border: '1px solid rgba(168,85,247,0.4)', borderRadius: 8, color: '#c9a6ff', font: "800 8px 'Orbitron',sans-serif", letterSpacing: '0.08em', padding: '6px 12px', cursor: 'pointer' }}>⚔️ ENTER A CHALLENGE CODE</button>
        </div>
